// Fixed default speeds (no personalization yet — no health-app integration
// or in-app run history to average from). Chosen by the user directly
// rather than a generic "6 min/km" guess.
export const DEFAULT_SPEED_KMH = { run: 9.5, walk: 4.7 };
